...
public class EmailAddressRecognizer {
	 ...
	 * @version 4.00		2026-09-16	Updated content: email now requires a dot followed by 2 or more alphabetic characters (TLD)
	 * 
	 */
	...
	public static String checkEmailAddress(String input) {
		...
		while (running) {
			...
			case 5: 
				// State 5: first character of TLD must be a letter
				if ((currentChar >= 'A' && currentChar <= 'Z')|| 			// Upper case
						(currentChar >= 'a' && currentChar <= 'z')) {		// Lower case
					nextState = 6;
				} else {
			...
			case 6: 
				// State 6: second character of TLD must be a letter
				if ((currentChar >= 'A' && currentChar <= 'Z')|| 			// Upper case
						(currentChar >= 'a' && currentChar <= 'z')) {		// Lower case
					nextState = 7;
				} else {
			...
			case 7: 
				// State 7: accepts more letters or another dot (e.g., .co.uk)
				if ((currentChar >= 'A' && currentChar <= 'Z')|| 			// Upper case
						(currentChar >= 'a' && currentChar <= 'z')) {		// Lower case
					nextState = 7;
				} else if (currentChar == '.') {	// another TLD
					nextState = 5;
				} else {
					running = false;
				}
		...
		case 1:
			...
			if (currentCharNdx >= input.length()) {
				emailAddressErrorMessage = "Please include an '@' symbol in the email address.\n";
			} else {
				emailAddressErrorMessage = "Must only be an alphanumberic character, a period, or the '@' symbol.\n";
			}
			return emailAddressErrorMessage;
		...
		case 2:
			...
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "Must be an alphanumberic character.\n";
			return emailAddressErrorMessage;
		...
		case 5:
			...
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "Domain extension must start with an alphabetic character.\n";
			return emailAddressErrorMessage;
		...
		case 6:
			...
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "Domain extension must be at least two alphabetic character.\n";
			return emailAddressErrorMessage;
		...
		case 7:
			...
			if (currentCharNdx < input.length()) {
				emailAddressIndexofError = currentCharNdx;
				emailAddressErrorMessage = "Invalid character in domain extension. Only letters are allowed.\n";
